...
<html lang="en">
    ...
    <body>
            ...
            <div class="slider">
                <ul>
                        <?php 
                            ...
                            for($i=1;$i<5;$i++){
                                $ResulFotoCarru=mysqli_query($link,"select * from carrucel Where ID_Carrucel='".$i."'");
                                while($row=mysqli_fetch_array($ResulFotoCarru)){
                                    echo('<li><img src="'.$row['URLFoto'].'" alt="" ></li>');
                                }
                            }
                        ?>
                </ul>
                ...
                <!-- 
                <ul>
                    '<li><img src='.$row['URLFoto']. 'alt="" ></li>'
                    <li><img src="assets/img/carrucel/anuncio2.png" alt=""></li>
                    <li><img src="assets/img/carrucel/anuncio3.png" alt=""></li>
                    <li><img src="assets/img/carrucel/anuncio4.png" alt=""></li>
                </ul>
                -->
            </div>        
        </header>
        ...
        <div class="py-5 text-center">
            <h1>******Aprovecha todo lo que tenemos para ti!!!*******</h1>
        </div>
            ...
            <div class="container px-4 px-lg-5 mt-5">
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    <?php
                            ...
                            $resultado=mysqli_query($link,"select * from productos order by ID_Producto ASC limit 0,8");
                            for($i=1;$i<9;$i++){
                                            ...
                                            <div class="col mb-5">
                                                <div class="card h-100">
                                                    ...
                                                    <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                                        <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="product_details.php?producto='.$row['ID_Producto'].'">Ver mas...</a></div>
                                                    </div>
                                                </div>
                                            </div>
                                            ';
